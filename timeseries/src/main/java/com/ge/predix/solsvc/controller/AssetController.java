...
public class AssetController {
	...
	{
		LOG.info("Start Ingest asset... assetsRequest:{}",assetsRequest[0].toString());
		LOG.info("AssetName :" + assetName);
		LOG.info("AssetRequest :" + assetsRequest);
		assetService.ingestAssetData(assetName, assetsRequest);
	...
	public Map<String, String> runAssetAnalytics(@PathVariable("assetName") String assetName,@PathVariable("assetId") String assetId)
	{
		...
		//LOG.info(results);
		return (Map<String, String>) assetService.getAssetDataByAssetId(assetName,assetId);
