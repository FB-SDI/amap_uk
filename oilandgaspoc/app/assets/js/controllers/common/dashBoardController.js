app.controller('dashboardController', ['$routeParams', '$scope', '$rootScope', '$location', 'locationMapService', 'assetManagementService', '$timeout', '$interval', function($routeParams, $scope, $rootScope, $location, locationMapService, assetManagementService, $timeout, $interval) {
