app.controller('assetManagementController', ['$routeParams', '$scope', '$rootScope', 'assetManagementService', function($routeParams, $scope, $rootScope, assetManagementService) {
